...
STRINGS: dict[str, dict[str, str]] = {
    ...
    "ladder_need_groups": {UK: "Спершу додай акаунт у групу (👥 Акаунти). Одна група — одна сторона; дві — хедж.",
                           EN: "Add an account to a group first (👥 Accounts). One group — one side; two — a hedge."},
